...
AS 'Amount of Actors by Last Name'
FROM actor
GROUP BY last_name;
...
SELECT payment.staff_id, staff.first_name,
 staff.last_name, payment.amount, payment.payment_date
FROM staff 
INNER JOIN payment
...
-- 8c. You find that you no longer need the view top_five genres. Write a query to delete it.
